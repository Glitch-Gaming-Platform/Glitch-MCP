...
describe("Glitch MCP tools", () => {
  it("exposes the expected public tool surface", () => {
    expect(glitchToolDefinitions.map((tool) => tool.name)).toEqual([
      ...
      "glitch_get_microtransaction_settings",
      "glitch_update_microtransaction_settings",
      "glitch_list_microtransaction_products",
      "glitch_create_microtransaction_product",
      "glitch_update_microtransaction_product",
      "glitch_archive_microtransaction_product",
      "glitch_list_microtransaction_providers",
      "glitch_update_microtransaction_provider",
      "glitch_refresh_microtransaction_provider",
      "glitch_create_microtransaction_provider_onboarding",
      "glitch_get_microtransaction_delivery_settings",
      "glitch_update_microtransaction_delivery_settings",
      "glitch_get_microtransaction_readiness",
      "glitch_list_microtransaction_orders",
      "glitch_get_microtransaction_order",
      "glitch_reconcile_microtransaction_order",
      "glitch_get_microtransaction_earnings",
      "glitch_list_microtransaction_refunds",
      "glitch_get_microtransaction_refund",
      "glitch_refund_microtransaction_order",
      "glitch_request_microtransaction_refund",
      "glitch_reconcile_microtransaction_refund",
      "glitch_list_microtransaction_deliveries",
      "glitch_replay_microtransaction_delivery",
      "glitch_acknowledge_microtransaction_delivery",
      ...
      "glitch_upload_microtransaction_media",
      "glitch_upload_file",
      ...
      "glitch_create_leaderboard",
      "glitch_update_leaderboard",
      "glitch_delete_leaderboard",
      "glitch_create_achievement",
      "glitch_update_achievement",
      "glitch_delete_achievement",
      "glitch_list_stat_definitions",
      "glitch_create_stat_definition",
      "glitch_update_stat_definition",
      "glitch_delete_stat_definition",
      "glitch_list_progression_seasons",
      "glitch_create_progression_season",
      "glitch_update_progression_season",
      "glitch_delete_progression_season",
      "glitch_list_player_stats",
      "glitch_create_progression_test_install",
      "glitch_upload_achievement_icon",
